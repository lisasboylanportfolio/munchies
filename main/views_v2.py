...
def categories(request):
  # see if user enterd data
  if request.method == 'POST':
    # Get  longatude and latitude
    zipcode='94549'
    search_code = request.POST.get('textfield', None)
...
def restaurants():
  ...
  # this would be called after  get_categories

  collection_id='1'   #DEBUG
  lat = '37.897485'   #DEBUG
  lon = '-122.112374' #DEBUG
  city = 'Lafayette'  #DEBUG
